...
static const char *colors[][3]      = {{
    ...
    [SchemeStatus]      = {{ urg_fg, urg_bg, urg_border  }}, 
    [SchemeTagsSel]     = {{ sel_fg, urg_bg, urg_border  }}, 
    [SchemeTagsNorm]    = {{ urg_fg, sel_bg, urg_border  }}, 
    [SchemeInfoSel]     = {{ sel_fg, urg_bg, urg_border  }}, 
    [SchemeInfoNorm]    = {{ urg_fg, sel_bg, urg_border  }}, 
}};
